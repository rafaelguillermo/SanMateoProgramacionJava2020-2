package co.edu.sanmateo.codigofuente.NataliaSilva08;

import co.edu.sanmateo.codigofuente.NataliaSilva08.modelo.Estudiante;
import co.edu.sanmateo.codigofuente.NataliaSilva08.operaciones.Universidad;
import java.io.*;
import java.util.*;
...
public class Main {
    ...
    public void menu() {
        ...
        try {
            File fileSaved = new File("/home/NATALIA/NetBeansProjects/SanMateoProgramacionJava2020-2/SanMateoProgramacionJava2020-2/ProgramaconJava2020-2/src/co/edu/sanmateo/codigofuente/NataliaSilva08");
        ...
        while (true) {
            ...
            if (option == 0) {
                ...
                try {
                    FileWriter fileWriter = new FileWriter("/home/NataliaSilva08/NetBeansProjects/SanMateoProgramacionJava2020-2/SanMateoProgramacionJava2020-2/ProgramaconJava2020-2/src/co/edu/sanmateo/codigofuente/NataliaSilva08", false);
